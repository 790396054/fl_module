...
import 'package:fl_module/dao/travel_dao.dart';
import 'package:fl_module/model/travel_model.dart';
...
class TravelTabPage extends StatefulWidget {
  ...
  const TravelTabPage(
      {Key? key, required this.travelUrl, required this.params, required this.groupChannelCode})
      : super(key: key);
...
class _TravelTabPageState extends State<TravelTabPage> with AutomaticKeepAliveClientMixin {
  ...
  void _loadData({loadMore = false}) {
    ...
    TravelDao.fetch(widget.travelUrl, widget.params,
