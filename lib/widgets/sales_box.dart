...
class SalesBox extends StatelessWidget {
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () {
                    NavigatorUtil.push(
                      context,
                      WebViewWidget(url: salesBox.moreUrl ?? '', title: '更多活动'),
                    );
                  },
                  child: const Text('获取更多福利 >', style: TextStyle(color: Colors.white, fontSize: 12),
                  ),
                ),
              )
            ],
  ...
  Widget _doubleItem(BuildContext context, CommonModel? leftCard, CommonModel? rightCard, bool big, bool last) {
    if (leftCard == null || rightCard == null ) return Container();
